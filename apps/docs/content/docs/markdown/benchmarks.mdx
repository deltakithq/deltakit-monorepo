...
|-----------|-------------------|----------------|---------|
| Short paragraph (~60 chars) | 133,000 ops/s | 21,000 ops/s | ~6.4x |
| Mixed content (~1.2kb) | 5,600 ops/s | 984 ops/s | ~5.7x |
| Streaming simulation (141 re-renders) | 80 ops/s | 15 ops/s | ~5.3x |
...
|-----------|-------------------|-----------|---------|
| Short paragraph | 4,047,000 ops/s | 24,000 ops/s | ~169x |
| Mixed content (~1.2kb) | 317,000 ops/s | 1,260 ops/s | ~252x |
| Streaming sim (141 parses) | 2,547 ops/s | 20 ops/s | ~125x |
