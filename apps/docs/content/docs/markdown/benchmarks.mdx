...
|-----------|-------------------|----------------|---------|
| Short paragraph (~60 chars) | 145,000 ops/s | 26,000 ops/s | ~5.5x |
| Mixed content (~1.2kb) | 5,500 ops/s | 1,150 ops/s | ~4.9x |
| Streaming simulation (141 re-renders) | 77 ops/s | 17 ops/s | ~4.8x |
...
|-----------|-------------------|-----------|---------|
| Short paragraph | 3,985,000 ops/s | 28,000 ops/s | ~141x |
| Mixed content (~1.2kb) | 312,000 ops/s | 1,427 ops/s | ~219x |
| Streaming sim (141 parses) | 2,619 ops/s | 20 ops/s | ~128x |
