...
description: Recipe for matching tool calls with their results and updating the UI when tools complete.
---
...
- [Display Tool Calls](/docs/react/tool-call-rendering) — Full UI patterns for tool calls
