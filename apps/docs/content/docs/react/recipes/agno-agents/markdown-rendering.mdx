...
description: Recipe for rendering streaming assistant responses as formatted markdown with syntax highlighting and styling using Agno agents.
---
...
If you're using a `<Part>` switch component (see [Display Tool Calls with Agno Agents](/docs/react/recipes/agno-agents/tool-call-rendering)), add markdown rendering to the text case:
