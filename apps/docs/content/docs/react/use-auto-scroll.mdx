...
**Type:** `ScrollBehavior` — Default: `"instant"`

The scroll behavior passed to `Element.scrollTo()`. Use `"instant"` (default) for streaming chat to avoid animation lag, or `"smooth"` for animated scrolling.
